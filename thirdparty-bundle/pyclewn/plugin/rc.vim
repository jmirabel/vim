function PyclewnMyMappings()
  ...
  vnoremap <C-P><C-P> <ESC>:exe "Cprint ".Get_visual_selection (" ")<CR>
  nnoremap <C-X><C-P> :exe "Cdbgvar " . expand("<cword>") <CR>
  vnoremap <C-X><C-P> <ESC>:exe "Cdbvar ".Get_visual_selection (" ")<CR>

  " dereference
  nnoremap <C-P><C-X> :exe "Cprint *" . expand("<cword>") <CR>
  vnoremap <C-P><C-X> <ESC>:exe "Cprint *" . Get_visual_selection (" " <CR>
  nnoremap <C-X><C-X> :exe "Cdbgvar *" . expand("<cword>") <CR>
  vnoremap <C-X><C-X> <ESC>:exe "Cdbgvar *" . Get_visual_selection (" ")<CR>

  " std::vector
  """ The following command must have been run. Put in .gdbinit for instance
  """ source ~/.gdb/printers
  nnoremap <C-P><C-V> :exe "C pvector ".expand("<cword>") <CR>
  vnoremap <C-P><C-V> <ESC>:exe "C pvector ".Get_visual_selection (" ") <CR>
  ...
  vnoremap <C-X><C-V> :exe "Cdbgvar *(double*)".Get_visual_selection(" ")."._M_impl._M_start@".Get_visual_selection(" ").".size()"

  " Eigen
  nnoremap <C-P><C-E> :exe "Cprint *(double*)".expand("<cword>").".m_data@".expand("<cword>").".size()"
  vnoremap <C-P><C-E> <ESC>:exe "Cprint *(double*)".Get_visual_selection(" ").".m_data@".Get_visual_selection(" ").".size()"
  nnoremap <C-X><C-E> :exe "Cdbgvar *(double*)".expand("<cword>").".m_data@".expand("<cword>").".size()"
  vnoremap <C-X><C-E> <ESC>:exe "Cdbgvar *(double*)".Get_visual_selection(" ").".m_data@".Get_visual_selection(" ").".size()"
  ...
  vnoremap <C-P><C-B> <ESC>:exe "C display_variable ".Get_visual_selection(" ") <CR>
  ...
  vnoremap <C-X><C-B> <ESC>:exe "Cdbgvar *(double*)".Get_visual_selection(" ").".data_.data_@".Get_visual_selection(" ").".data_.size_" <CR>
...
function! Get_visual_selection (joint)
